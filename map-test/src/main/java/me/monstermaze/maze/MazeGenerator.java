...
public class MazeGenerator {
    ...
    public void generateMazeAsync(final Runnable onDone) {
        ...
        // Build the maze paths in place directly over the arena terrain.
        // Like the source, each maze cell lays its themed top/middle/bottom
        // blocks right on top of whatever is there (no volume clearing), so
        // the maze floats naturally over the map (e.g. lava) and generation
        // is near-instant.
