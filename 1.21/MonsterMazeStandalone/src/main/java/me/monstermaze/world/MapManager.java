...
public final class MapManager {
    ...
    /**
     * Returns whether the map's world is actually installed in the server world container.
     * mm_void is generated by Monster Maze and is always considered available.
     */
    public boolean isAvailable(String map) {
        ...
        if ("mm_void".equalsIgnoreCase(folder)) return true;
